...
const lst=['try again','Congratulations, You Have Won the coupon!','try again :)','Congratulations, You Have Won the coupon!','try again']
var ab=0;
const generateValue = (angleValue) => {
  for (let i of spinValues) {

    if (angleValue >= i.minDegree && angleValue <= i.maxDegree) {
      text.innerHTML = lst[(Math.floor(Math.random() * lst.length))];
